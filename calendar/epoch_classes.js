...
Epoch.prototype.setLang = function()  //all language settings for Epoch are made here.  Check Date.dateFormat() for the Date object's language settings
{
	...
	this.daylist = new Array('Вс','Пн','Вт','Ср','Чт','Пт','Сб','Вс','Пн','Вт','Ср','Чт','Пт','Сб'); /*<lang:ru>*/
	this.months_sh = new Array('Январь','Февраль','Март','Апрель','Май','Июнь','Июль','Август','Сенябрь','Октябрь','Ноябрь','Декабрь');
	this.monthup_title = 'Следующий месяц';
	this.monthdn_title = 'Предыдущий месяц';
	this.clearbtn_caption = 'Очистить';
	this.clearbtn_title = 'Очистить выбранные даты';
	this.maxrange_caption = 'Это максимальный диапазон';
};
//-----------------------------------------------------------------------------
