<html>
<head>
<title> ООО "СПЕКТР" - Публикации</title>
...
<?php $currentPage = "publication.php"; include("menu.html")?>

<table id="Table_03" width="960" align="center" border="0" cellpadding="0" cellspacing="10"  bgcolor="#ffffff">
<tr valign="top">
	<td width="960" align="center"><?php include("publication_menu.php")?>
		</td>
</tr>
<tr valign="top">
	<td width="960" height="400">
	<?php include("_inwork.html")?>
    </td>
</tr>
<tr valign="bottom">
